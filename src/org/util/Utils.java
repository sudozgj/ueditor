...
public class Utils {
	 ...
	 * 保存图片的根目录
	 */
//	public final static String PICSRC = ServletActionContext.getRequest().getRealPath("/")+"upload/";
...
//	public final static String PICURL = "http://192.168.1.150:8080/LifeBank/upload/";
	 ...
	 */
	public final static String PICSRC = ServletActionContext.getRequest().getRealPath("/")+"upload/";
//	public final static String PICSRC = "/opt/apache-tomcat-7.0.70/webapps/bank/upload/";
	public final static String PICURL = "http://120.76.22.150:8080/LifeBank/upload/";
